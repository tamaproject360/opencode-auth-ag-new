 ...
 * Saves to ~/.config/opencode/generated-images/ (consistent with other plugin data).
 */
 ...
 * Uses ~/.config/opencode/generated-images/ — consistent with other plugin data paths.
 */
function getImageOutputDir(): string {
  const xdgConfig = process.env.XDG_CONFIG_HOME ?? path.join(os.homedir(), ".config")
  const outputDir = path.join(xdgConfig, "opencode", "generated-images")
